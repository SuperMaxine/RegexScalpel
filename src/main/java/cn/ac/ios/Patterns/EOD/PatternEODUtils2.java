...
//    }
    ...
    private static ReDoSBean getEODRedosBeanHelper2(TreeNode root, String regex) throws InterruptedException {
        ...
        while (!stack.isEmpty()) {
            ...
            if (isGeneralizedCountingNodeWithMaxNumGreaterThanOne(node)) {
                ...
                ArrayList<TreeNode> allOrChildNodeList = node.getAllOrNode();
                for (TreeNode orChildNode: allOrChildNodeList) {
                    String r0 = getR0(node, orChildNode);
                    String r4 = getR4(node, orChildNode);
                    String infix1 = getExampleByDkBricsAutomaton(new ArrayList<>(Collections.singleton(r0)), null, 0);
                    if (infix1 == null) continue;
                    String infix2 = getExampleByDkBricsAutomaton(new ArrayList<>(Collections.singleton(r4)), null, 0);
                    if (infix2 == null) continue;

                    for (int i = 0; i < orChildNode.getChildCount() - 2; i += 2) {
                        for (int j = i + 2; j < orChildNode.getChildCount(); j++) {
                            if (!Collections.disjoint(orChildNode.getChild(i).getFirst(), orChildNode.getChild(j).getFirst())) {
                                ...
                                intersection.addAll(orChildNode.getChild(i).getFirst());
                                intersection.retainAll(orChildNode.getChild(j).getFirst());
...
//                                System.out.println(getOrSymbolTreeNode(node.getChild(i)).getData());
                                String regex1n = reWriteMetaEscapeForEODInfix(orChildNode, orChildNode.getChild(i), getOrSymbolTreeNode(orChildNode.getChild(i))); // 除掉r2
                                String regex2n = reWriteMetaEscapeForEODInfix(orChildNode, orChildNode.getChild(j), getOrSymbolTreeNode(orChildNode.getChild(j)));  // 除掉r1
...
//                                System.out.println(1);
                                ...
                                if (infix != null) {
                                    ...
                                    attackBean.setInfix(infix1 + infix + infix2);
                                    attackBean.setSuffix(root.getNonMatchStr());
                                    attackBean.initType(AttackType.EXPONENT);
//                                    attackBean.setPatternType(PatternType.EOD_i1);
...
//                                System.out.println(2);
                                ...
                                if (infix != null) {
                                    ...
                                    attackBean.setSuffix(root.getNonMatchStr());
                                    attackBean.initType(AttackType.EXPONENT);
//                                    attackBean.setPatternType(PatternType.EOD_i2);
//                                    attackBean.setConflictPoint(new Pair<>());
                                    attackBeanList.add(attackBean);
                                }
...
//                                System.out.println(3);
                                ...
                                if (infix != null) {
                                    ...
                                    attackBean.setSuffix(root.getNonMatchStr());
                                    attackBean.initType(AttackType.EXPONENT);
//                                    attackBean.setPatternType(PatternType.EOD_i3);
//                                    attackBean.setConflictPoint(new Pair<>());
                                    attackBeanList.add(attackBean);
                                }
...
//                                System.out.println(4);
                                ...
                                if (infix != null) {
                                    ...
                                    attackBean.setSuffix(root.getNonMatchStr());
                                    attackBean.initType(AttackType.EXPONENT);
//                                    attackBean.setPatternType(PatternType.EOD_i4);
//                                    attackBean.setConflictPoint(new Pair<>());
                                    attackBeanList.add(attackBean);
                                }
                            }
                            ...
                            if (!Collections.disjoint(orChildNode.getChild(i).getFirst(), orChildNode.getChild(j).getFollowLast())) {
...
//                                System.out.println(node.getChild(j).getData() + node.getChild(i).getData() + " EOD(ii)");
                                ...
                                String infix = generateInfixStringForEOD(orChildNode.getChild(i).getData(), orChildNode.getChild(j).getData(), 5, "");
                                if (infix != null) {
                                    AttackBean attackBean = new AttackBean();
                                    attackBean.setPrefix(root.getMatchStr(node));
                                    attackBean.setInfix(infix1 + infix + infix2);
...
//                                attackBean.setConflictPoint(new Pair<>());
                            ...
                            if (!Collections.disjoint(orChildNode.getChild(j).getFirst(), orChildNode.getChild(i).getFollowLast())) {
...
//                                System.out.println(node.getChild(i).getData() + node.getChild(j).getData() + " EOD(iii)");
                                ...
                                String infix = generateInfixStringForEOD(orChildNode.getChild(j).getData(), orChildNode.getChild(i).getData(), 5, "");
                                if (infix != null) {
                                    AttackBean attackBean = new AttackBean();
                                    attackBean.setPrefix(root.getMatchStr(node));
                                    attackBean.setInfix(infix1 + infix + infix2);
...
//            bean = getEODRedosBeanHelper(tree, regex);
            bean = getEODRedosBeanHelper2(tree, regex);
