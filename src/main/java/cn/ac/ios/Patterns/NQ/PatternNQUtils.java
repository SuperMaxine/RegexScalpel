...
import static cn.ac.ios.TreeNode.Utils.ReDoSTreeToRegex;
...
import static cn.ac.ios.Utils.SpecialStringUtils.getSpecialSuffixStringWithAllCountingNodes;
...
public class PatternNQUtils {
    ...
    public static TreeNode getStandardizedReDoSTree(TreeNode sourceReDoSTree, String language) throws InterruptedException {
        ...
        String regex = ReDoSTreeToRegex(ReDoSTree);
...
//        ReDoSTree = getNodeByRemoveRegExpFlag(ReDoSTree);
        ...
        regex = ReDoSTreeToRegex(ReDoSTree);
